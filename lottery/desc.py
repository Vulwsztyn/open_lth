...
class LotteryDesc(Desc):
    ...
    def add_args(parser: argparse.ArgumentParser, defaults: 'LotteryDesc' = None):
        ...
        if pruning_strategy:
            ...
            if defaults and defaults.pruning_hparams.pruning_strategy == pruning_strategy or (
                    [defaults.pruning_hparams.pruning_strategy, pruning_strategy] == ['sparse_global', 'sparse_local']):
